...
// let ok = confirm('Есть ли Вам 18 лет');
// if (ok) {
//   alert('для взрослых');
// } else {
...
//       if (isFreindly(i, j)) arr.push([i, j]);
//     }
//   }
//   return arr;
// }
...
//   } return arr;
// }
// console.log(getSimpleDivisor(220))
...
//   for (let arr of arrs) {
//     if (!inArray(elem, arr)) return false
//   } return true
// }
